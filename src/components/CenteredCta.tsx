// Enhanced by AI on 2025-08-11T00:32:12.959Z
// Section: cta
// Category: cta
...
export default function CTA() {
  const stats = [
    { value: "50K+", label: "Teams Collaborating", icon: Users },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of high-performing teams who have streamlined their workflow, improved communication, and boosted productivity with our collaboration platform.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Free Team Plan</h3>
              <p className="text-sm text-muted-foreground">
                Up to 10 team members, no credit card required
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Get your entire team collaborating in minutes
              </p>
            </div>
          </div>
        </div>
